...
/*************************************************************************
 * Author:  https://github.com/wsieroci/audio-recognizer
 *
 * Compilation: javac model.FFT.java Execution: java model.FFT N Dependencies: model.Complex.java
 * 
 * Compute the model.FFT and inverse model.FFT of a length N complex sequence. Bare bones
...
public class FFT {
	...
	// compute the model.FFT of x[], assuming its length is a power of 2
	public static Complex[] fft(Complex[] x) {
		...
		// radix 2 Cooley-Tukey model.FFT
		if (N % 2 != 0) {
	...
	// compute the inverse model.FFT of x[], assuming its length is a power of 2
	...
	public static Complex[] cconvolve(Complex[] x, Complex[] y) {
		...
		// compute model.FFT of each sequence
		Complex[] a = fft(x);
		Complex[] b = fft(y);
	...
	// display an array of model.Complex numbers to standard output
	 ...
	 * 
	 * % java model.FFT 4 x ------------------- -0.03480425839330703
